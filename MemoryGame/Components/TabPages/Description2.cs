...
public class Description2 : TabPage
{

    private Button buttonStart;
    public TabControl tabControl;
    private Size formClientSize;
    public Description2(TabControl tabControl, Size formClientSize)
    {
        this.Text = "Description2";
        ...
        this.buttonStart.Click += (s, e) => tabControl.SelectedIndex = 4;
